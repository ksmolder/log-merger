...
public class LogFile implements AutoCloseable {
	...
	public LogFile(String fileName, BufferedReader bufferedReader, SimpleDateFormat simpleDateFormat,
			CliOptions cliOptions, int marker) {
	...
	private Date extractTimestampFromLine() {
		...
		try {
			...
			String message = "Could not transform value '" + value + "' in line " + currentLineNumber
					+ " to a timestamp";
